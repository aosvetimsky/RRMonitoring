...
using RRMonitoring.Mining.Application.Extensions;
using RRMonitoring.Mining.Infrastructure.Extensions;
using ClassFromApplicationAssembly = RRMonitoring.Mining.Application.Extensions.ServiceCollectionExtensions;

namespace RRMonitoring.Mining.Api;

public class Startup(IConfiguration configuration, IWebHostEnvironment environment)
{
	private const string AssemblyPrefix = "RRMonitoring.Mining";
	private const string CorsName = "RRMonitoring.Mining";
