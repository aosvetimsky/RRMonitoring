...
namespace RRMonitoring.Identity.Infrastructure.Database.Migrations
{
    ...
    [Migration("20250310115129_AddBlockedBy")]
    partial class AddBlockedBy
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RRMonitoring.Identity.Domain.Entities.Account", b =>
                {
                    ...
                    b.HasIndex("UserId", "Name", "IsDeleted")
                        .IsUnique()
                        .HasDatabaseName("ix_account_user_id_name_is_deleted")
                        .HasFilter("is_deleted = false");

                    b.ToTable("account", (string)null);
                });

            modelBuilder.Entity("RRMonitoring.Identity.Domain.Entities.ApiKey", b =>
                {
                    b.Property<string>("Key")
                        .HasColumnType("text")
                        .HasColumnName("key");
                    ...
                    b.Property<List<string>>("IpWhiteList")
                        .HasColumnType("text[]")
                        .HasColumnName("ip_white_list");
                    ...
                    b.HasIndex("AccountId")
                        .HasDatabaseName("ix_api_key_account_id");

                    b.HasIndex("TypeId")
                        .HasDatabaseName("ix_api_key_type_id");

                    b.ToTable("api_key", (string)null);
                });

            modelBuilder.Entity("RRMonitoring.Identity.Domain.Entities.ApiKeyPermission", b =>
                {
                    b.Property<string>("Key")
                        .HasColumnType("text")
                        .HasColumnName("key");

                    b.Property<byte>("ExternalPermissionId")
                        .HasColumnType("smallint")
                        .HasColumnName("external_permission_id");

                    b.HasKey("Key", "ExternalPermissionId")
                        .HasName("pk_api_key_permission");

                    b.HasIndex("ExternalPermissionId")
                        .HasDatabaseName("ix_api_key_permission_external_permission_id");

                    b.ToTable("api_key_permission", (string)null);
                });

            modelBuilder.Entity("RRMonitoring.Identity.Domain.Entities.ApiKeyType", b =>
                {
                    b.Property<byte>("Id")
                        .HasColumnType("smallint")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_api_key_type");

                    b.ToTable("api_key_type", (string)null);
            ...
            modelBuilder.Entity("RRMonitoring.Identity.Domain.Entities.ExternalPermission", b =>
                {
                    b.Property<byte>("Id")
                        .HasColumnType("smallint")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_external_permission");

                    b.ToTable("external_permission", (string)null);
            ...
            modelBuilder.Entity("RRMonitoring.Identity.Domain.Entities.User", b =>
                {
                    ...
                    b.HasIndex("BlockedBy")
                        .HasDatabaseName("ix_user_blocked_by");
            ...
            modelBuilder.Entity("RRMonitoring.Identity.Domain.Entities.ApiKey", b =>
                {
                    b.HasOne("RRMonitoring.Identity.Domain.Entities.Account", "Account")
                        .WithMany()
                        .HasForeignKey("AccountId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_api_key_account_account_id");

                    b.HasOne("RRMonitoring.Identity.Domain.Entities.ApiKeyType", "Type")
                        .WithMany()
                        .HasForeignKey("TypeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_api_key_api_key_type_type_id");
            ...
            modelBuilder.Entity("RRMonitoring.Identity.Domain.Entities.ApiKeyPermission", b =>
                {
                    b.HasOne("RRMonitoring.Identity.Domain.Entities.ExternalPermission", "ExternalPermission")
                        .WithMany()
                        .HasForeignKey("ExternalPermissionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_api_key_permission_external_permission_external_permission_");

                    b.HasOne("RRMonitoring.Identity.Domain.Entities.ApiKey", "ApiKey")
                        .WithMany("ApiKeyPermissions")
                        .HasForeignKey("Key")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_api_key_permission_api_keys_api_key_temp_id");

                    b.Navigation("ApiKey");

                    b.Navigation("ExternalPermission");
                });
            ...
            modelBuilder.Entity("RRMonitoring.Identity.Domain.Entities.User", b =>
                {
                    b.HasOne("RRMonitoring.Identity.Domain.Entities.User", "BlockedUser")
                        .WithMany()
                        .HasForeignKey("BlockedBy")
                        .HasConstraintName("fk_user_user_blocked_user_id");
