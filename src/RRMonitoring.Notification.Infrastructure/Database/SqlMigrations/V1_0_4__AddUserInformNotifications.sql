...
begin
	...
	-- Email notification of account locking by admin

	select 'UserBlockNotification' into notification_identifier;
	select 'Ваш аккаунт заблокирован' into template_subject;
	select '<!DOCTYPE html><html lang="ru"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>RedRock Pool</title></head><body style="margin:0;padding:0;font-family:Arial,sans-serif;font-size:18px;font-weight:400;line-height:1.5;color:#000"><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td align="center" style="padding:16px 8px"><table width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:540px"><tr><td class="header" style="padding:32px 48px;background:#fff linear-gradient(120deg,transparent 32%,#f36126 32%,#f36126 68%,transparent 68%) top center repeat-x;background-size:30px 20px;border:1px solid #f9f9f9"><div style="padding:16px 0"><img src="https://wrlimit.com/redrock/email-logo.png" alt="RedRock Pool"></div><div style="padding:16px 0;font-size:24px;font-weight:700;color:#000">Здравствуйте, {{username}}</div><div style="padding:16px 0;color:#000">Ваша учетная запись была заблокирована администратором по причине:</div><div style="padding:16px 0;color:#000"> {{reason}}.</div><div style="padding:16px 0;color:#000">Дата блокировки: {{block_date}}</div><div style="padding:16px 0;color:#8e97b4">Это письмо сформировано автоматически, не отвечайте на него.</div></td></tr></table></td></tr></table></body></html>' into template_data;
	...
	-- Email notification of account unlocking by admin

	select 'UserUnblockNotification' into notification_identifier;
	select 'Ваш аккаунт разблокирован' into template_subject;
	select '<!DOCTYPE html><html lang="ru"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>RedRock Pool</title></head><body style="margin:0;padding:0;font-family:Arial,sans-serif;font-size:18px;font-weight:400;line-height:1.5;color:#000"><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td align="center" style="padding:16px 8px"><table width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:540px"><tr><td class="header" style="padding:32px 48px;background:#fff linear-gradient(120deg,transparent 32%,#f36126 32%,#f36126 68%,transparent 68%) top center repeat-x;background-size:30px 20px;border:1px solid #f9f9f9"><div style="padding:16px 0"><img src="https://wrlimit.com/redrock/email-logo.png" alt="RedRock Pool"></div><div style="padding:16px 0;font-size:24px;font-weight:700;color:#000">Здравствуйте, {{username}}</div><div style="padding:16px 0;color:#000">Поздравляем! Ваша учетная запись вновь активна.<div style="padding:16px 0;color:#8e97b4">Это письмо сформировано автоматически, не отвечайте на него.</div></td></tr></table></td></tr></table></body></html>' into template_data;
