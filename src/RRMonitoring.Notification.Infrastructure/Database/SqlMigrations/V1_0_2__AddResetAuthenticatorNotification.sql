...
begin
    ...
    -- Sms notification about reset authenticator

	select 'ResetAuthenticatorNotification' into notification_identifier;
	select 'Сброс Google Authenticator' into template_subject;
	select 'Администратор Red Rock запрос сброс Google Authenticator. Ваш код для сброса: {{code}}' into template_data;
