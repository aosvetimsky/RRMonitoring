...
namespace RRMonitoring.Notification.Infrastructure.Migrations
{
    ...
    [Migration("20240202104420_NormalizeNotificationHistory")]
    partial class NormalizeNotificationHistory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RRMonitoring.Notification.Domain.Entities.Notification", b =>
                {
                    ...
                    b.HasIndex("GroupId")
                        .HasDatabaseName("ix_notification_group_id");
            ...
            modelBuilder.Entity("RRMonitoring.Notification.Domain.Entities.NotificationMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<bool?>("PushIsRead")
                        .HasColumnType("boolean")
                        .HasColumnName("push_is_read");
                    ...
                    b.HasIndex("ChannelId")
                        .HasDatabaseName("ix_notification_message_channel_id");

                    b.HasIndex("ExternalMessageId")
                        .HasDatabaseName("ix_notification_message_external_message_id");

                    b.HasIndex("NotificationId")
                        .HasDatabaseName("ix_notification_message_notification_id");

                    b.ToTable("notification_message", (string)null);
                });

            modelBuilder.Entity("RRMonitoring.Notification.Domain.Entities.NotificationMessageHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_notification_message_history");

                    b.HasIndex("NotificationMessageId")
                        .HasDatabaseName("ix_notification_message_history_notification_message_id");

                    b.HasIndex("StatusId")
                        .HasDatabaseName("ix_notification_message_history_status_id");

                    b.ToTable("notification_message_history", (string)null);
                });
            ...
            modelBuilder.Entity("RRMonitoring.Notification.Domain.Entities.Notification", b =>
                {
                    b.HasOne("RRMonitoring.Notification.Domain.Entities.NotificationGroup", "Group")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_notification_notification_group_group_id");
            ...
            modelBuilder.Entity("RRMonitoring.Notification.Domain.Entities.NotificationMessage", b =>
                {
                    b.HasOne("RRMonitoring.Notification.Domain.Entities.Channel", "Channel")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_notification_message_channel_channel_id");

                    b.HasOne("RRMonitoring.Notification.Domain.Entities.Notification", "Notification")
                        .WithMany()
                        .HasForeignKey("NotificationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_notification_message_notification_notification_id");
            ...
            modelBuilder.Entity("RRMonitoring.Notification.Domain.Entities.NotificationMessageHistory", b =>
                {
                    b.HasOne("RRMonitoring.Notification.Domain.Entities.NotificationMessage", "NotificationMessage")
                        .WithMany("NotificationMessageHistory")
                        .HasForeignKey("NotificationMessageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_notification_message_history_notification_message_notificat");
                    ...
                    b.HasOne("RRMonitoring.Notification.Domain.Entities.Status", "Status")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_notification_message_history_status_status_id");
            ...
            modelBuilder.Entity("RRMonitoring.Notification.Domain.Entities.NotificationMessage", b =>
                {
                    b.Navigation("NotificationMessageHistory");
                });
