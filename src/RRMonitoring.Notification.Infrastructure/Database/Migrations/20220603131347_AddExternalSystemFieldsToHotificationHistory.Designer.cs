...
namespace RRMonitoring.Notification.Infrastructure.Migrations
{
    ...
    [Migration("20220603131347_AddExternalSystemFieldsToHotificationHistory")]
    partial class AddExternalSystemFieldsToHotificationHistory
    {
            ...
            modelBuilder.Entity("RRMonitoring.Notification.Domain.Entities.RecipientSetting", b =>
                {
                    ...
                    b.HasIndex("NotificationId")
                        .HasDatabaseName("ix_recipient_setting_notification_id");
